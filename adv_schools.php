...
$user = new User();$cat = null;
$override = new OverideData(); $results = null;$pages = null;
if(!$_GET['cat'] == null && !$_GET['org'] == null){
        ...
        switch($_GET['cat']){
            case 1:
              $cat = 'Primary School';
                break;
            case 2:
                $cat = 'Secondary School';
                break;
            case 3:
                $cat = 'Vocation Training';
                break;
            case 4:
                $cat = 'College';
                break;
       ...
       // if($_GET['num'] == 1){$page = 0;}else{$page = ($_GET['num']*40)-40;}
        ...
        $results = $override->getNews('schools','category',$cat,'org_id',$_GET['org']);
        $orgName = $override->get('edu_org','id',$_GET['org']);
       // $page = ceil($count / 40);
...
<div role="main" class="main">
    <div class="container">
       <h4><?=$orgName[0]['name'].' '?>List of <?=$cat?>s</h4>
        <div class="row">
            <div class="col-md-12">
                <section class="panel">
